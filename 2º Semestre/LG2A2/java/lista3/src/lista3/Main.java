...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Servico servico2 = new Servico(12346, "Troca de Óleo", 567.15);
        ...
        Mecanico mecanico2 = new Mecanico("555.555.555-55", "Giovani", "troca óleo como ninguém antes");
        ...
        System.out.println("Valor da ordem de Serviço de código 444: " + oficina.buscaOSCodigo(444).calculaValorTotal());

        //Busca ordens de servico pelo CPF na oficina
        System.out.println("Ordens de serviço em que o Mecânico de CPF 666.666.666-66 trabalhou: ");
